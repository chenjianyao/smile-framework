 ...
 *
 */
package com.smileframework.admin.core.dto;
...
public class ResponseDto<T> extends ModelMap implements Serializable {
	...
	public static ResponseDto<Object> newSuccessResponseDto(Object t) {
	...
	public static ResponseDto<Object> newFailResponseDto(String code) {
		return newFailResponseDto("1", code, "操作失败!", null);
	}

	public static ResponseDto<Object> newFailResponseDto(String code, String msg) {
		return newFailResponseDto("1", code, msg, null);
	}

	public static ResponseDto<Object> newFailResponseDto(String status, String code, String msg) {
		return newFailResponseDto(status, code, msg, null);
	}

	public static ResponseDto<Object> newFailResponseDto(String status, String code, String msg, Object t) {
		ResponseDto<Object> responseDto = new ResponseDto<Object>();
