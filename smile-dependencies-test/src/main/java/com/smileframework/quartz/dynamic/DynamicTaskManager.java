...
//		try {
//			if (job == null || (JobEnum.ScheduleJobStatus.ZK_DEL.getCode().equals(job.getJobStatus())
...
//			// 不存在，创建一个
//			if (null == trigger) {
//				Class clazz = JobEnum.ScheduleJobConStatus.CONCURRENT_IS.getCode().equals(job.getIsConcurrent())
